						...
						<td width="30%" align="center" valign="top">
							<h4><i class="fa fa-address-card-o"></i> Document<br> verified</h4>
								...
								<?php }elseif (strlen($row['verified_document']) > 10) { ?>
									...
									<br>
									<i class="fa fa-paperclip"></i> <a href="<?php echo SITE_URL; ?>uploads/<?php echo $row['verified_document']; ?>"  data-lightbox="image-1" data-title="Document">view file</a>  &nbsp;(<a href="<?php echo SITE_URL; ?>uploads/<?php echo $row['verified_document']; ?>" target="_blank">link <i class="fa fa-external-link"></i></a>)<br>
									<br>
						...
						<td width="30%" align="center" valign="top">
							<h4><i class="fa fa-map-marker"></i> Address<br> verified</h4>
								...
								<?php }elseif (strlen($row['verified_address']) > 10) { ?>
									...
									<span class="label label-warning">awating review</span>
									<br>
									<i class="fa fa-paperclip"></i> <a href="<?php echo SITE_URL; ?>uploads/<?php echo $row['verified_address']; ?>" data-lightbox="image-1" data-title="Address Document Proof">view file</a> &nbsp;(<a href="<?php echo SITE_URL; ?>uploads/<?php echo $row['verified_address']; ?>" target="_blank">link <i class="fa fa-external-link"></i></a>)<br>
									<br>
