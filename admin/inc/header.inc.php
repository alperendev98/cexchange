...
<head>
	<meta charset="utf-8">
	<title><?php echo $title; ?> | Exchangerix Admin Panel</title>
...
<body>
	...
	<div class="container">
			...
			<?php if (PageAllowed(9)) { ?><li <?php if (@$cpage==9) echo "class='selected'"; ?>><a href="exchanges.php">Exchanges <?php if (GetPendingETotal() > 0) { ?><span class="badge" style="background: #95c939"><?php echo GetPendingETotal(); ?></span><?php } ?></a></li><?php } ?>
			...
			<?php if (PageAllowed(13)) { ?><li <?php if (@$cpage==13) echo "class='selected'"; ?>><a href="countries.php">Countries</a></li><?php } ?>
			<?php if (PageAllowed(14)) { ?><li <?php if (@$cpage==14) echo "class='selected'"; ?>><a href="reviews.php">Testimonials</a></li><?php } ?>
			<?php if (PageAllowed(20)) { ?><li <?php if (@$cpage==20) echo "class='selected'"; ?>><a href="payment_methods.php">Payment Methods</a></li><?php } ?>
			<?php if (PageAllowed(21)) { ?><li <?php if (@$cpage==21) echo "class='selected'"; ?>><a href="news.php">News</a></li><?php } ?>
			<?php if (PageAllowed(22)) { ?><li <?php if (@$cpage==22) echo "class='selected'"; ?>><a href="content.php">Content</a></li><?php } ?>
			<?php if (PageAllowed(23)) { ?><li <?php if (@$cpage==23) echo "class='selected'"; ?>><a href="etemplates.php">Email Templates</a></li><?php } ?>
			<?php if (PageAllowed(24)) { ?><li <?php if (@$cpage==24) echo "class='selected'"; ?>><a href="email2users.php">Email Members</a></li><?php } ?>
			<li <?php if (@$cpage==29) echo "class='selected'"; ?>><a href="reports.php">Reports</a></li>
			<?php if (PageAllowed(25)) { ?><li <?php if (@$cpage==25) echo "class='selected'"; ?>><a href="gateways.php">Gateways</a></li><?php } ?>
			<?php if (PageAllowed(26)) { ?><li <?php if (@$cpage==26) echo "class='selected'"; ?>><a href="settings.php" class="last">Settings</a></li><?php } ?>
